...
public abstract class Weapon extends StationaryGameObject {
    ...
    /**
     * determines how far to the left and right the GameObjects.MovingGameObjects.Ammo will miss the intended target
     */
    private double degreesOfInaccuracy;

    /**
     * the force that the GameObjects.StationaryGameObjects.Weapon exerts on the user after firing
     */
    private double recoilForce;

    /**
     * the force that the GameObjects.StationaryGameObjects.Weapon exerts on the target after contact
     */
    ...
    /**
     * determines if the GameObjects.StationaryGameObjects.Weapon will fire automatically
     * always false for primary Weapons
     */
    private boolean autoFire;

    /**
     * the amount of money that is takes to purchase the GameObjects.StationaryGameObjects.Weapon
     */
    private int price;

    /**
     * the number of times that the damage section of the GameObjects.StationaryGameObjects.Weapon has been upgraded
     */
    private int damageUpgradePoints;

    /**
     * the number of times that the range section of the GameObjects.StationaryGameObjects.Weapon has been upgraded
     */
    private int rangeUpgradePoints;

    /**
     * the number of times that the accuracy section of the GameObjects.StationaryGameObjects.Weapon has been upgraded
     */
    private int accuracyUpgradePoints;

    /**
     * the number of times that the fire rate section of the GameObjects.StationaryGameObjects.Weapon has been upgraded
     */
    private int fireRateUpgradePoints;

    /**
     * the number of times that the recoil section of the GameObjects.StationaryGameObjects.Weapon has been upgraded
     */
    private int recoilUpgradePoints;

    /**
     * the number of times that the knock back section of the GameObjects.StationaryGameObjects.Weapon has been upgraded
     */
    private int knockBackUpgradePoints;

    /**
     * the number of times that the critical damage section of the GameObjects.StationaryGameObjects.Weapon has been upgraded
     */
    private int criticalDamageUpgradePoints;

    /**
     * the number of frames that the GameObjects.StationaryGameObjects.Weapon needs to wait until firing again
     */
    private double shotDelay;

    /**
     * the frame where the GameObjects.MovingGameObjects.Ammo was last fired
     */
